...
const MyEnrollments = () => {
  ...
  const { enrolledCourses, calculateCourseDuaration, navigate, userData, fetchUserEnrolledCourses, backendUrl, getToken, calculateNoOfLectures } = useContext(AppContext)
