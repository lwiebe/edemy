...
const CourseDetails = () => {
  ...
  const { allCourses, calculateRating, calculateChapterTime, calculateCourseDuaration, calculateNoOfLectures, currency, backendUrl, userData, getToken } = useContext(AppContext)
          ...
          <div className='p-5'>
                ...
                <div className='flex items-center text-sm md:text-base gap-4 pt-2 md:pt-4 text-gray-500'>
                  ...
                  <div className='flex items-center gap-1'>
                    ...
                    <p>{calculateCourseDuaration(courseData)}</p>
                  </div>
                ...
                <button onClick={enrollCourse} className='md:mt-6 mt-4 w-full py-3 rounded-lg bg-blue-600 text-white font-medium'
