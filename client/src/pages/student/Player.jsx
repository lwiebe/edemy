          ...
          {playerData ? (
            <div>
              ...
              <div className='flex justify-between items-center mt-1'>
                ...
                <button onClick={()=> markLectureAsCompleted(playerData.lectureId)} className='text-blue-600 cursor-pointer'>{progressData && progressData.lectureCompleted.includes(playerData.lectureId) ? 'Complete' : 'Mark Complete'}</button>
              </div>
            </div>
          )
            :
